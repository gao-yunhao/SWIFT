...
INLINE static void sink_props_init(struct sink_props *sp,
  ...
  sp->sink_formation_contracting_gas_check = parser_get_opt_param_int(params, "GEARSink:sink_formation_contracting_gas_check", default_sink_formation_check_all);
    ...
    sp->sink_formation_hill_density_check = parser_get_opt_param_int(params, "GEARSink:sink_formation_hill_density_check", default_sink_formation_check_all);
  ...
  message("sink_formation_hill_density_check = %d", sp->sink_formation_hill_density_check);
